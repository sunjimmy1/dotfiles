...
set shell=/usr/bin/bash"                        " set default shell
...
"    Plug 'jiangmiao/auto-pairs'                 " autoclose deimiters
  ...
  " markdown {
    ...
    Plug 'ferrine/md-img-paste.vim'             " markdown image paste
    if has("nvim")
...
" vimtex{
  ...
  let g:vimtex_view_method = 'sioyek' "'zathura'
" }
" airline {
...
" }
" vim markdown {
  let g:markdown_mapping_switch_status = '<Leader>n'
" }
" coq {
...
augroup vimrc
  ...
  autocmd ColorScheme * highlight clear Search
        \ | highlight Search ctermbg=None ctermfg=None guibg=None
  autocmd ColorScheme * highlight CocHighlightText ctermbg=None ctermfg=None guibg=None
augroup END
