...
local create_button = function(symbol, hover_color, text, command)
	local icon = wibox.widget({
		...
		valign = "center",
		font = icon_font,
		markup = helpers.ui.colorize_text(symbol, beautiful.light_grey),
	...
	button:connect_signal("mouse::leave", function()
		icon.markup = helpers.ui.colorize_text(icon.text, beautiful.light_grey)
		button.border_color = beautiful.black
	end)
